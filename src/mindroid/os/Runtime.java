...
public class Runtime {
    ...
    /**
     * Causes the Mindroid application framework to stop running and the program to exit.
     * The exit code is set to the arg1 argument of the shutdown hook message.
     * The exit reason is set to the obj argument of the shutdown hook message.
     *
     * @param code
