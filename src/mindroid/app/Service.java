...
import mindroid.content.ContextWrapper;
import mindroid.content.Intent;
import mindroid.os.IBinder;

/**
 * A Service is an application component representing either an application's desire
 * to perform a longer-running operation or to supply functionality for other applications to use.  
 * Each service class must have a corresponding service declaration in its package's 
 * <code>MindroidManifest.xml</code>.  
 ...
 * to do any CPU intensive or blocking (such as
 ...
 * {@link mindroid.content.Context#startService Context.startService()}, which
 ...
 * {@link mindroid.content.Context#bindService Context.bindService()}, which
 ...
 * calls {@link mindroid.content.Context#startService Context.startService()} then the system will
 ...
 * running until {@link mindroid.content.Context#stopService Context.stopService()} or
 ...
 * 
 * <p>Clients can also use {@link mindroid.content.Context#bindService Context.bindService()} to
 ...
 * {@link mindroid.os.IBinder} object that the service returns from its
 ...
 * started <em>or</em> there are one or more connections to it.  
 * Once neither of these situations hold, the service's {@link #onDestroy} method is called
 ...
 * 
 * <p>The Mindroid system will attempt to keep the process hosting a service
...
public abstract class Service extends ContextWrapper {
     ...
     * 
     * @param intent The Intent supplied to {@link mindroid.content.Context#startService}, 
     * as given.
     ...
     * {@link mindroid.os.IBinder} is usually for a complex interface.
     * 
     * @param intent The Intent that was used to bind to this service,
     * as given to {@link mindroid.content.Context#bindService
     ...
     * @hide
     */
    public final void attach(Context context, Process process, ComponentName component) {
    	mProcess = process;
