 ...
 * can be used with {@link mindroid.content.Context#startService} or
 * {@link mindroid.content.Context#bindService} to communicate with a
 * {@link mindroid.app.Service}.
 *
 * <p>An Intent provides a facility for performing late runtime binding between the code in
 * different applications. Its most significant use is in the launching of services, where it
 * can be thought of as the glue between services. It is basically a passive data structure
